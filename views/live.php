<?php
  ...
  xhtmlHeaders(__FILE__, $SLANG['Live'] );
?>
  <body class="zm">
    <!--[if lt IE 7]>
      ...
      <div id="viewcontrol" > <!-- begin viewcontrol -->
        <table> <!-- begin table -->
          ...
          <tr> <!-- begin row -->
            ...
            <td>
              <div>
                <div><button class="btn btn-default btngridsize" type="button" onclick="loadcameragrid(this,2);">2 Columns</button></div>
                <div><button class="btn btn-default btngridsize" type="button" onclick="loadcameragrid(this,3);" DISABLED>3 Columns</button></div>
                <div><button class="btn btn-default btngridsize" type="button" onclick="loadcameragrid(this,4);">4 Columns</button></div>
              </div>
            </td>
