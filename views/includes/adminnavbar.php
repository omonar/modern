  ...
  <div class="navbar-collapse collapse">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="#" id="zm-new-zone-opener"><span class="fa fa-plus-circle"></span> Add zone</a></li>
          <li class="divider"></li>
          <li class="dropdown-header">Edit Existing</li>
          <?php
            foreach($cameras as $camera) {
          ?>
            <li><a href="?skin=classic&amp;view=zones&amp;mid=<?=$camera['Id']?>" class="init-colorbox"><span class="fa fa-edit"></span> <?=$camera['Name']?></a></li>
          <?php
            }
          ?>
        </ul>
